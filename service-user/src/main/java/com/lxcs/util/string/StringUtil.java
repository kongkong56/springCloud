...
public class StringUtil {
     ...
     * @return
     */
    public static String toSecurityStringSeq(String str, int startIndex, int length) {
        if (StringUtils.isEmpty(str)) {
            return "";
        }
        ...
        if (!m.matches() || str.length() < startIndex + 1) {
            return str;
        }
        ...
        if (str.length() > startIndex + length) {
            endString = str.substring(startIndex + length);
            padCnt = length;
        } else {
            endString = "";
            padCnt = str.length() - startIndex;
        }

        return startString + StringUtils.rightPad("", padCnt, "*") + endString;
    }
     ...
     * @return
     */
    public static String newlineByDigit(String str, int digit, String type) {
        if (StringUtils.isEmpty(str)) {
            return "";
        }
        ...
        if (str.length() > digit) {
            ...
            if ("page".equals(type)) {
                ...
                str = addressLine1 + (char)11 + addressLine2;
            }
        }
